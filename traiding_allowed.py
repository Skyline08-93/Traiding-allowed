...
async def check_triangle(base, mid1, mid2, symbols, markets):
    try:
        ...
        trade_side1 = 'buy' if f"{mid1}/{base}" in symbols else 'sell'
        trade_side2 = 'buy' if f"{mid2}/{mid1}" in symbols else 'sell'
        trade_side3 = 'sell' if f"{mid2}/{base}" in symbols else 'buy'
